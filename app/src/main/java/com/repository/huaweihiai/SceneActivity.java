...
public class SceneActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnscene = (Button) findViewById(R.id.scene);
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case MSG_SERIVCE_CONNECTED:
                    ...
                    Toast.makeText(SceneActivity.this, "bind success", Toast.LENGTH_SHORT).show();
                    sceneDetector = new SceneDetector(SceneActivity.this);
                    break;
                case MSG_SERIVCE_DISCONNECTED:
                    Toast.makeText(SceneActivity.this, "disconnect", Toast.LENGTH_SHORT).show();
                    break;
...
//            } else {
            ...
            Cursor cursor = SceneActivity.this.getContentResolver().query(selectedImage, filePathColumn, null, null, null);
            cursor.moveToFirst();
